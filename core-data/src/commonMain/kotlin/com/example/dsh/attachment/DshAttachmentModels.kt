...
/** 输入区待发送的通用文件草稿；仅内存，不落盘。旧 Host 无文件 content 类型，发送前由插件落盘。 */
enum class DshFileDraftState { SELECTED, UPLOADING, FAILED }

data class DshPendingFile(
    val clientId: String,
    val mediaType: String,
    val name: String,
