...
fun ViewContainer<*, *>.DshSettingsPage(
    loading: () -> Boolean,
    error: () -> String,
...
fun dshSettingsPermissionLabel(snapshot: DshSettingsSnapshot): String {
...
fun dshSettingsLocaleLabel(snapshot: DshSettingsSnapshot): String = when (snapshot.localeValue) {
    "zh" -> "简体中文"
    "en" -> "English"
    else -> "跟随电脑端"
}
...
fun dshThemeModeLabel(mode: DshThemeMode): String = when (mode) {
...
fun ViewContainer<*, *>.DshSettingsCard(
    colors: () -> com.example.dsh.theme.DshColorTokens = { com.example.dsh.theme.DshDefaultTheme.light },
    topMargin: Float = 0f,
...
/** 设置页分组标题：与卡片内图标左边距对齐。 */
fun ViewContainer<*, *>.DshSettingsCardGroupTitle(
    title: String,
    colors: () -> com.example.dsh.theme.DshColorTokens = { com.example.dsh.theme.DshDefaultTheme.light },
) {
    Text {
...
fun ViewContainer<*, *>.DshSettingsGroupTitle(title: String, colors: () -> com.example.dsh.theme.DshColorTokens = { com.example.dsh.theme.DshDefaultTheme.light }) {
    Text {
        attr {
            text(title)
            marginTop(20f)
...
fun ViewContainer<*, *>.DshSettingsRow(
    icon: String,
    title: String,
    value: () -> String,
    onClick: () -> Unit,
...
fun ViewContainer<*, *>.DshSettingsChoicePicker(
    title: String,
...
fun ViewContainer<*, *>.DshPersonalizationPage(
...
/** 互斥单选行：标题 + 说明 + 右侧选中态圆勾。 */
fun ViewContainer<*, *>.DshPersonalizationChoiceRow(
    title: String,
    subtitle: String,
    selected: () -> Boolean,
    onClick: () -> Unit,
...
fun ViewContainer<*, *>.DshPersonalizationSwitchRow(
    title: String,
    subtitle: String,
    checked: () -> Boolean,
