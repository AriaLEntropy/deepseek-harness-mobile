...
actual fun createDshLogStore(path: String): DshLogStore = DshOhosLogStore(path)
...
private class DshOhosLogStore(private val path: String) : DshLogStore {
    ...
    override fun levelCounts(filter: LogFilter): Map<LogLevel, Long> {
    ...
    override fun distinctSessions(): List<String> = queryStrings(DshLogSql.DISTINCT_SESSIONS)

    override fun distinctTypes(): List<String> = queryStrings(DshLogSql.DISTINCT_TYPES)
