 ...
 */
internal object DshFileValidator {
 ...
 */
internal fun dshFileTypeLabel(name: String, mediaType: String): String {
...
internal fun dshFormatFileSize(bytes: Long): String {
...
internal fun dshFileIconAsset(name: String): String = when (dshFileExtension(name)) {
...
internal fun dshFileIconTint(name: String, colors: DshColorTokens): Color = when (dshFileExtension(name)) {
