...
data class DshLogQuery(val filter: LogFilter = LogFilter(), val search: String = "") {
...
data class DshLogCatalog(val sessions: List<String>, val types: List<String>, val retained: Int)
data class DshLogPageResult(
