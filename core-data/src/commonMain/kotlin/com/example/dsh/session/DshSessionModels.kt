...
enum class DshSessionCacheState {
    SYNCED,
    STALE,
    SYNC_FAILED,
}

data class DshLegacyRemoteProfile(
    val mode: DshConnectionMode,
    val host: String,
    val sshPort: Int,
    val username: String,
