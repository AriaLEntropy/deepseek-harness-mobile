...
class DshTerminalCardAttr : ComposeAttr() {
...
class DshTerminalCardView : ComposeView<DshTerminalCardAttr, ComposeEvent>() {
...
fun ViewContainer<*, *>.DshTerminalCard(init: DshTerminalCardView.() -> Unit) {
    addChild(DshTerminalCardView(), init)
}

class DshReadCardAttr : ComposeAttr() {
...
class DshReadCardView : ComposeView<DshReadCardAttr, ComposeEvent>() {
...
fun ViewContainer<*, *>.DshReadCard(init: DshReadCardView.() -> Unit) {
    addChild(DshReadCardView(), init)
}

/** Fixed-height scrollable text body used by expandable tool rows. */

class DshLongTextView : ComposeView<DshLongTextAttr, ComposeEvent>() {
...
class DshLongTextAttr : ComposeAttr() {
    var content: String by observable("")
...
fun ViewContainer<*, *>.DshLongText(init: DshLongTextView.() -> Unit) {
