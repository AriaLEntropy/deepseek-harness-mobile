...
import com.example.dsh.export.dshParseWebCard
 ...
 */
data class DshRemoteToolCallModel(
    val callId: String,
    val toolName: String,
...
fun DshRemoteToolCallModel.toRemoteMessage(key: String): DshMessage = DshMessage(
    id = key,
...
object DshRemoteToolCallModels {
...
fun dshWireEvent(root: JSONObject): JSONObject = root.optJSONObject("event") ?: root

/** Unwrap both history's {view:{view}} and live's {view:{for,view}} forms. */
fun dshWireView(root: JSONObject): JSONObject? {
...
fun dshAskReadableBody(input: String, output: String): String {
