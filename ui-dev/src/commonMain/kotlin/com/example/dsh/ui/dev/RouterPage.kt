package com.example.dsh.ui.dev
...
class RouterNavigationBar : ComposeView<RouterNavigationBarAttr, ComposeEvent>() {
...
class RouterNavigationBarAttr : ComposeAttr() {
    var title: String by observable("")
    var backDisable = false
}

fun ViewContainer<*, *>.RouterNavBar(init: RouterNavigationBar.() -> Unit) {
