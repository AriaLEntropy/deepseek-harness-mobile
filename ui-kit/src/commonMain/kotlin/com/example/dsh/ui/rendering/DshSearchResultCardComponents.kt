...
class DshSearchResultCardAttr : ComposeAttr() {
...
class DshSearchResultCardView : ComposeView<DshSearchResultCardAttr, ComposeEvent>() {
...
fun ViewContainer<*, *>.DshSearchResultCard(init: DshSearchResultCardView.() -> Unit) {
