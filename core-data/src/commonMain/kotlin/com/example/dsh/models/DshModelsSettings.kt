 ...
 */
data class DshProviderCredential(
...
data class DshProviderModel(
    val id: String = "",
    val name: String = "",
    val raw: JSONObject? = null,
)

data class DshProviderConfig(
    val provider: String,
...
fun dshDeriveKeyRef(provider: String): String {
...
/** 自定义路由的本地校验文案；空串表示通过。 */
fun dshCustomRouteError(route: String, taken: List<String>): String = when {
    route.isEmpty() -> ""
