...
expect fun dshMathWebViewSupported(): Boolean
...
class DshMathParagraphView : ComposeView<DshMathParagraphAttr, ComposeEvent>() {
...
class DshMathParagraphAttr : ComposeAttr() {
...
fun ViewContainer<*, *>.DshMathParagraph(init: DshMathParagraphView.() -> Unit) {
