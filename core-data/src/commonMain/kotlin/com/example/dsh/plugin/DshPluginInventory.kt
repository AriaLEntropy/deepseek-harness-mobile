...
fun parseDshPluginInventory(value: JSONObject): List<DshPluginEntry> {
...
fun filterDshPlugins(entries: List<DshPluginEntry>, keyword: String, phase: String): List<DshPluginEntry> {
