...
import com.example.dsh.connection.DshSseEventKind
import com.example.dsh.connection.DshSseHandle
            ...
            for (groupIndex in 0 until groups.length()) {
                ...
                for (modelIndex in 0 until models.length()) {
                    ...
                    options += DshModelOption(
                        ...
                        reasoningEffort = if (selected) effort else reasoning?.optString("defaultEffort"),
