 ...
 */
enum class DshProcessDisplayMode {
    UNIFIED,
    CLASSIC,
}

const val DSH_PREF_PROCESS_DISPLAY = "chat_process_display"
const val DSH_PREF_EXPAND_MODAL = "chat_expand_in_modal"
const val DSH_PREF_SHOW_CONNECTORS = "chat_show_connectors"
const val DSH_PREF_SHOW_RESULT_CARDS = "chat_show_result_cards"

fun dshProcessDisplayLabel(mode: DshProcessDisplayMode): String = when (mode) {
    DshProcessDisplayMode.UNIFIED -> "统一折叠"
    DshProcessDisplayMode.CLASSIC -> "经典"
}

fun dshProcessDisplayValue(mode: DshProcessDisplayMode): String = when (mode) {
    DshProcessDisplayMode.UNIFIED -> "unified"
    DshProcessDisplayMode.CLASSIC -> "classic"
}

fun dshProcessDisplayFromValue(value: String): DshProcessDisplayMode =
